...
},{"../utils/settings":"ts/utils/settings.ts","../ui/logout":"ts/ui/logout.ts","../ui/renderSearch":"ts/ui/renderSearch.ts","../helpers/loadCurrentItems":"ts/helpers/loadCurrentItems.ts","../ui/login":"ts/ui/login.ts","../ui/register":"ts/ui/register.ts","../ui/showNavbarBgOnScroll":"ts/ui/showNavbarBgOnScroll.ts","../helpers/getLoggedInUser":"ts/helpers/getLoggedInUser.ts"}],"ts/ui/addProduct.ts":[function(require,module,exports) {
"use strict";
...
const addNewProduct = (url, token, obj) => {
  (0, _removeMessage.removeMessage)("#msg");
  const options = {
    method: "POST",
    headers: {
...
},{"../helpers/showMessage":"ts/helpers/showMessage.ts","../helpers/removeMessage":"ts/helpers/removeMessage.ts","../helpers/fetcData":"ts/helpers/fetcData.ts"}],"ts/add.ts":[function(require,module,exports) {
"use strict";
...
var _addProduct = require("./ui/addProduct");
...
if (user && user.username === "admin") {
  ...
  const handleNewproduct = e => {
    e.preventDefault();
    (0, _removeMessage.removeMessage)("#msg");
    const isValid = (0, _validateFields.validateFields)(".add-form .form-control");
    ...
    (0, _addProduct.addNewProduct)(URL, token, productObject);
    (0, _validateFields.removeValidationStyle)(".add-form .form-control");
    form.reset();
  };

  form.addEventListener("submit", handleNewproduct);
}
},{"./utils/settings":"ts/utils/settings.ts","./utils/storage":"ts/utils/storage.ts","./elements/renderNavbar":"ts/elements/renderNavbar.ts","./helpers/removeMessage":"ts/helpers/removeMessage.ts","./ui/addProduct":"ts/ui/addProduct.ts","./helpers/validateFields":"ts/helpers/validateFields.ts","./helpers/getLoggedInUser":"ts/helpers/getLoggedInUser.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/add.ts"], null)
//# sourceMappingURL=/add.6d3a1466.js.map