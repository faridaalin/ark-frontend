...
const home = "home";
exports.home = home;
},{}],"ts/ui/logout.ts":[function(require,module,exports) {
"use strict";
...
},{"../utils/settings":"ts/utils/settings.ts","../ui/logout":"ts/ui/logout.ts","../ui/renderSearch":"ts/ui/renderSearch.ts","../helpers/loadCurrentItems":"ts/helpers/loadCurrentItems.ts","../ui/login":"ts/ui/login.ts","../ui/register":"ts/ui/register.ts","../ui/showNavbarBgOnScroll":"ts/ui/showNavbarBgOnScroll.ts","../helpers/getLoggedInUser":"ts/helpers/getLoggedInUser.ts"}],"ts/helpers/getTotalPrice.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getTotalPrice = exports.getTotalPricePerItem = void 0;
...
const getTotalPricePerItem = product => {
  ...
  return (0, _getRoundNumber.getRoundNumber)(+(qty * product.product.price));
};

exports.getTotalPricePerItem = getTotalPricePerItem;

const getTotalPrice = () => {
  const currentCart = (0, _storage.getFromLocal)(_settings.cart);
  let total = 0;
  ...
  total = currentCart.reduce((acc, obj) => {
    obj.qtySize.forEach(item => {
      if (item.qty) acc += obj.product.price * item.qty;
    });
    return acc;
  }, 0);
  return total = (0, _getRoundNumber.getRoundNumber)(+total);
};

exports.getTotalPrice = getTotalPrice;
},{"../utils/settings":"ts/utils/settings.ts","../utils/storage":"ts/utils/storage.ts","../helpers/getRoundNumber":"ts/helpers/getRoundNumber.ts"}],"ts/helpers/deleteItem.ts":[function(require,module,exports) {
"use strict";
...
},{}],"ts/elements/renderCartItems.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderCartItems = void 0;

var _settings = require("../utils/settings");

var _storage = require("../utils/storage");

var _getTotalPrice = require("../helpers/getTotalPrice");

var _deleteItem = require("../helpers/deleteItem");
...
const removeItemFromCart = cartItems => {
  ...
  deleteItems.forEach(itemToDelete => {
    const handleItemToDelete = e => {
      const id = +e.target.attributes[1].value;
      const updatedCartITems = (0, _deleteItem.deleteItem)(cartItems, id);
      (0, _storage.saveCartItemsToLocal)(_settings.cart, updatedCartITems);
      renderCartItems();
    };
...
const renderCartItems = () => {
  const cartItems = (0, _storage.getFromLocal)(_settings.cart);
  ...
  cartItems.map(item => {
    const price = (0, _getRoundNumber.getRoundNumber)(+item.product.price);
    cartItemsContainer.innerHTML += `
    <div>
      <div class="cart-detail mb-5 pb-5 mb-md-0">
        <div class="bag-container d-flex pb-4 mb-4">
          ...
          <a href="/pdp.html?id=${item.product.id}">
            <div class="bag-img embed-responsive embed-responsive-4by3" style="background-image: url(${item.product.image_url})"></div>
          </a>
                  ...
                  <div class="d-flex flex-wrap justify-content-between align-items-center w-100">
                    ...
                    <div class="pl-lg-2">
                      <p class="large-text large-text--total flex-grow-1 align-text-bottom mb-0">Total:
                        ${(0, _getTotalPrice.getTotalPricePerItem)(item)} NOK
                      </p>
                    </div>
                  </div>
                </div>
  ...
  <div class="checkout-container">
    ...
    <div class="total pt-2 pb-4 d-flex justify-content-between align-items-center"><span>Total sum</span><span>${(0, _getTotalPrice.getTotalPrice)()} NOK</span></div>
...
},{"../utils/settings":"ts/utils/settings.ts","../utils/storage":"ts/utils/storage.ts","../helpers/getTotalPrice":"ts/helpers/getTotalPrice.ts","../helpers/deleteItem":"ts/helpers/deleteItem.ts","../helpers/getRoundNumber":"ts/helpers/getRoundNumber.ts"}],"ts/cart.ts":[function(require,module,exports) {
"use strict";

var _renderNavbar = require("./elements/renderNavbar");

var _renderCartItems = require("./elements/renderCartItems");

(0, _renderNavbar.renderNavbar)();
(0, _renderCartItems.renderCartItems)();
},{"./elements/renderNavbar":"ts/elements/renderNavbar.ts","./elements/renderCartItems":"ts/elements/renderCartItems.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/cart.ts"], null)
//# sourceMappingURL=/cart.256aeed5.js.map