...
},{"../utils/settings":"ts/utils/settings.ts","../ui/logout":"ts/ui/logout.ts","../ui/renderSearch":"ts/ui/renderSearch.ts","../helpers/loadCurrentItems":"ts/helpers/loadCurrentItems.ts","../ui/login":"ts/ui/login.ts","../ui/register":"ts/ui/register.ts","../ui/showNavbarBgOnScroll":"ts/ui/showNavbarBgOnScroll.ts","../helpers/getLoggedInUser":"ts/helpers/getLoggedInUser.ts"}],"ts/ui/deleteProduct.ts":[function(require,module,exports) {
"use strict";
...
const deleteProduct = (url, token) => {
  ...
  const handleDeleteProduct = () => __awaiter(void 0, void 0, void 0, function* () {
    const options = {
      method: "DELETE",
      headers: {
    ...
    (0, _fetcData.fectData)(url, options).then(result => {
      if (!result || typeof result === "string") {
        return (0, _showMessage.showMessage)("danger", result, "#msg");
      }

      if (result.created_at) {
        const msg = `${result.title} is deleted`;
        (0, _showMessage.showMessage)("success", msg, "#msg");
      }
...
},{"../helpers/showMessage":"ts/helpers/showMessage.ts","../helpers/fetcData":"ts/helpers/fetcData.ts"}],"ts/ui/updateProduct.ts":[function(require,module,exports) {
"use strict";
...
},{"../helpers/showMessage":"ts/helpers/showMessage.ts","../helpers/fetcData":"ts/helpers/fetcData.ts"}],"ts/helpers/getUrlParam.ts":[function(require,module,exports) {
"use strict";
...
},{}],"ts/edit.ts":[function(require,module,exports) {
"use strict";
...
var _deleteProduct = require("./ui/deleteProduct");
...
if (user && user.username === "admin") {
  ...
  (0, _fetcData.fectData)(URL).then(product => {
    if (!product || typeof product === "string") {
      return (0, _showMessage.showMessage)("danger", product, ".edit-form .message-container");
    }
  ...
  const handleFormEdit = e => {
    e.preventDefault();
    (0, _removeMessage.removeMessage)(".edit-form .message-container");
    const isValid = (0, _validateFields.validateFields)(".edit-form .form-control");
  ...
  (0, _deleteProduct.deleteProduct)(URL, token);
  form.addEventListener("submit", handleFormEdit);
}
},{"./utils/settings":"ts/utils/settings.ts","./utils/storage":"ts/utils/storage.ts","./elements/renderNavbar":"ts/elements/renderNavbar.ts","./helpers/showMessage":"ts/helpers/showMessage.ts","./helpers/validateFields":"ts/helpers/validateFields.ts","./ui/deleteProduct":"ts/ui/deleteProduct.ts","./ui/updateProduct":"ts/ui/updateProduct.ts","./helpers/removeMessage":"ts/helpers/removeMessage.ts","./helpers/fetcData":"ts/helpers/fetcData.ts","./helpers/getUrlParam":"ts/helpers/getUrlParam.ts","./helpers/getLoggedInUser":"ts/helpers/getLoggedInUser.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
