...
},{"../utils/settings":"ts/utils/settings.ts","../ui/logout":"ts/ui/logout.ts","../ui/renderSearch":"ts/ui/renderSearch.ts","../helpers/loadCurrentItems":"ts/helpers/loadCurrentItems.ts","../ui/login":"ts/ui/login.ts","../ui/register":"ts/ui/register.ts","../ui/showNavbarBgOnScroll":"ts/ui/showNavbarBgOnScroll.ts","../helpers/getLoggedInUser":"ts/helpers/getLoggedInUser.ts"}],"ts/elements/renderFavs.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderFavs = void 0;
...
const renderFavs = () => {
  const savedFavs = (0, _storage.getFromLocal)(_settings.favs) ? (0, _storage.getFromLocal)(_settings.favs) : [];
  const msg = savedFavs.length === 0 ? "You have no items in your favourites list." : "";
  (0, _spinner.spinner)(".fav-container");
  setTimeout(() => {
    (0, _renderAllProducts.default)(savedFavs, msg, ".fav-container");
  }, 500);
};

exports.renderFavs = renderFavs;
},{"../utils/storage":"ts/utils/storage.ts","../utils/settings":"ts/utils/settings.ts","../elements/renderAllProducts":"ts/elements/renderAllProducts.ts","../elements/renderNavbar":"ts/elements/renderNavbar.ts","../elements/spinner":"ts/elements/spinner.ts"}],"ts/fav.ts":[function(require,module,exports) {
"use strict";

var _renderFavs = require("./elements/renderFavs");

var _renderNavbar = require("./elements/renderNavbar");

(0, _renderNavbar.renderNavbar)();
(0, _renderFavs.renderFavs)();
},{"./elements/renderFavs":"ts/elements/renderFavs.ts","./elements/renderNavbar":"ts/elements/renderNavbar.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/fav.ts"], null)
//# sourceMappingURL=/fav.0ba82de6.js.map