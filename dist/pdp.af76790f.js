...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"ts/helpers/getUrlParam.ts":[function(require,module,exports) {
"use strict";
...
const home = "home";
exports.home = home;
},{}],"ts/helpers/createRatingArray.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createRatingArray = void 0;

const createRatingArray = product => {
  let productRating = [];
...
exports.createRatingArray = createRatingArray;
},{}],"ts/helpers/getRoundNumber.ts":[function(require,module,exports) {
"use strict";
...
},{}],"ts/components/productDetail.ts":[function(require,module,exports) {
"use strict";
...
var _createRatingArray = require("../helpers/createRatingArray");

var _getRoundNumber = require("../helpers/getRoundNumber");

const productDetail = product => {
  const container = document.querySelector(".pdp-detail-container");
  const rating = (0, _createRatingArray.createRatingArray)(product);
...
},{"../helpers/createRatingArray":"ts/helpers/createRatingArray.ts","../helpers/getRoundNumber":"ts/helpers/getRoundNumber.ts"}],"ts/ui/logout.ts":[function(require,module,exports) {
"use strict";
...
},{"../utils/settings":"ts/utils/settings.ts","../elements/renderNavbar":"ts/elements/renderNavbar.ts"}],"ts/helpers/loadCurrentItems.ts":[function(require,module,exports) {
"use strict";
...
},{"../utils/settings":"ts/utils/settings.ts","../utils/storage":"ts/utils/storage.ts"}],"ts/helpers/getFavsIcon.ts":[function(require,module,exports) {
"use strict";
...
},{"../helpers/loadCurrentItems":"ts/helpers/loadCurrentItems.ts","../elements/renderAllProducts":"ts/elements/renderAllProducts.ts","../elements/spinner":"ts/elements/spinner.ts"}],"../node_modules/lodash-es/isObject.js":[function(require,module,exports) {
"use strict";
...
},{"../utils/settings":"ts/utils/settings.ts","../ui/logout":"ts/ui/logout.ts","../ui/renderSearch":"ts/ui/renderSearch.ts","../helpers/loadCurrentItems":"ts/helpers/loadCurrentItems.ts","../ui/login":"ts/ui/login.ts","../ui/register":"ts/ui/register.ts","../ui/showNavbarBgOnScroll":"ts/ui/showNavbarBgOnScroll.ts","../helpers/getLoggedInUser":"ts/helpers/getLoggedInUser.ts"}],"ts/helpers/addQty.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addQty = void 0;
...
},{}],"ts/helpers/addSize.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addSize = void 0;
...
},{}],"ts/helpers/addtoCart.ts":[function(require,module,exports) {
"use strict";
...
var _addQty = require("../helpers/addQty");

var _addSize = require("../helpers/addSize");

const addToCart = product => {
  const addToCartBtn = document.querySelector("#addToCart");
  let localCart = (0, _storage.getFromLocal)(_settings.cart);
  (0, _addQty.addQty)();
  ...
  addToCartBtn.addEventListener("click", function () {
    ...
    const selectedSize = (0, _addSize.addSize)();
    ...
    if (!alreadyInCart) {
      ...
      (0, _storage.saveCartItemsToLocal)(_settings.cart, localCart);
      return;
    } else {
...
},{"../utils/settings":"ts/utils/settings.ts","../utils/storage":"ts/utils/storage.ts","../helpers/addQty":"ts/helpers/addQty.ts","../helpers/addSize":"ts/helpers/addSize.ts"}],"ts/helpers/setMetaTags.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setMetaTags = void 0;
...
},{}],"ts/pdp.ts":[function(require,module,exports) {
"use strict";

var _getUrlParam = require("./helpers/getUrlParam");
...
var _addtoCart = require("./helpers/addtoCart");
...
var _setMetaTags = require("./helpers/setMetaTags");

(0, _renderNavbar.renderNavbar)();

(() => {
  const id = (0, _getUrlParam.getUrlParam)("id");
  (0, _removeMessage.removeMessage)(".pdp-container .message-container");
  const URL = `${_settings.BASE_URL}/products/${id}`;
  (0, _spinner.spinner)(".pdp-detail-container");
  (0, _fetcData.fectData)(URL).then(result => {
    if (!result || typeof result === "string") {
      (0, _spinner.spinner)(".pdp-detail-container .spinner-container", "d-none");
      (0, _showMessage.showMessage)("danger", result, ".pdp-container .message-container");
      return;
    }
    ...
    (0, _setMetaTags.setMetaTags)(result.description, result.title);
    (0, _productDetail.productDetail)(result);
    (0, _addtoCart.addToCart)(result);
  });
})();
},{"./helpers/getUrlParam":"ts/helpers/getUrlParam.ts","./utils/settings":"ts/utils/settings.ts","./components/productDetail":"ts/components/productDetail.ts","./elements/renderNavbar":"ts/elements/renderNavbar.ts","./helpers/addtoCart":"ts/helpers/addtoCart.ts","./helpers/fetcData":"ts/helpers/fetcData.ts","./helpers/showMessage":"ts/helpers/showMessage.ts","./helpers/removeMessage":"ts/helpers/removeMessage.ts","./elements/spinner":"ts/elements/spinner.ts","./helpers/setMetaTags":"ts/helpers/setMetaTags.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/pdp.ts"], null)
//# sourceMappingURL=/pdp.af76790f.js.map