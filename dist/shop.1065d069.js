...
},{"../utils/storage":"ts/utils/storage.ts"}],"ts/elements/spinner.ts":[function(require,module,exports) {
"use strict";
...
},{"../helpers/loadCurrentItems":"ts/helpers/loadCurrentItems.ts","../elements/renderAllProducts":"ts/elements/renderAllProducts.ts","../elements/spinner":"ts/elements/spinner.ts"}],"ts/helpers/getLoggedInUser.ts":[function(require,module,exports) {
"use strict";
...
},{"../utils/settings":"ts/utils/settings.ts","../ui/logout":"ts/ui/logout.ts","../ui/renderSearch":"ts/ui/renderSearch.ts","../helpers/loadCurrentItems":"ts/helpers/loadCurrentItems.ts","../ui/login":"ts/ui/login.ts","../ui/register":"ts/ui/register.ts","../ui/showNavbarBgOnScroll":"ts/ui/showNavbarBgOnScroll.ts","../helpers/getLoggedInUser":"ts/helpers/getLoggedInUser.ts"}],"ts/helpers/getCategoriesObject.ts":[function(require,module,exports) {
"use strict";
...
},{}],"ts/elements/renderFilterOptions.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderFilterOptions = void 0;
...
const filterByCategory = products => {
  ...
  checkboxesNode.forEach(checkbox => {
    ...
    checkbox.addEventListener("click", e => {
      (0, _spinner.spinner)(".shop-container");
      ...
      timeout = window.setTimeout(() => {
        ...
        if (category && checkedCategory) {
          ...
          if (filteredCategory.length > 0) {
            (0, _renderAllProducts.default)(filteredCategory, "Shop is currently empty", ".shop-container");
          ...
          (0, _renderAllProducts.default)(products, "Shop is currently empty", ".shop-container");
...
const renderFilterCategories = products => {
  ...
  const categories = (0, _getCategoriesObject.getCategoriesObject)(products);
  ...
  range.addEventListener("input", e => {
    ...
    window.setTimeout(() => {
      if (filteredPrice.length > 0) {
        (0, _renderAllProducts.default)(filteredPrice, "Shop is currently empty", ".shop-container");
      } else {
...
exports.renderFilterOptions = renderFilterOptions;
},{"../elements/renderAllProducts":"ts/elements/renderAllProducts.ts","../elements/spinner":"ts/elements/spinner.ts","../helpers/getCategoriesObject":"ts/helpers/getCategoriesObject.ts"}],"ts/shop.ts":[function(require,module,exports) {
"use strict";
...
var _renderFilterOptions = require("./elements/renderFilterOptions");
...
(() => {
  (0, _removeMessage.removeMessage)(".shop-container .message-container");
  const URL = `${_settings.BASE_URL}/products`;
  (0, _spinner.spinner)(".shop-container");
  (0, _fetcData.fectData)(URL).then(result => {
    if (!result || typeof result === "string") {
      return (0, _showMessage.showMessage)("danger", result, ".shop-container .message-container");
    }

    (0, _storage.saveToSessionStorage)(_settings.allProducts, result);
    (0, _renderAllProducts.default)(result, "Shop is currently empty", ".shop-container");
    (0, _renderFilterOptions.renderFilterOptions)(result);
  });
})();
},{"./utils/settings":"ts/utils/settings.ts","./elements/renderAllProducts":"ts/elements/renderAllProducts.ts","./elements/renderNavbar":"ts/elements/renderNavbar.ts","./utils/storage":"ts/utils/storage.ts","./elements/renderFilterOptions":"ts/elements/renderFilterOptions.ts","./helpers/fetcData":"ts/helpers/fetcData.ts","./helpers/showMessage":"ts/helpers/showMessage.ts","./helpers/removeMessage":"ts/helpers/removeMessage.ts","./elements/spinner":"ts/elements/spinner.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/shop.ts"], null)
//# sourceMappingURL=/shop.1065d069.js.map