...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"ts/helpers/getCategoriesObject.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getCategoriesObject = void 0;

const getCategoriesObject = data => data.reduce((acc, item) => {
  acc[item.category] = {
    item
  };
  return acc;
...
},{}],"ts/utils/settings.ts":[function(require,module,exports) {
"use strict";
...
const home = "home";
exports.home = home;
},{}],"ts/elements/renderGridCategory.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderGridCategory = void 0;

var _getCategoriesObject = require("../helpers/getCategoriesObject");
...
const renderGridCategory = products => {
  ...
  const modifiedCategores = (0, _getCategoriesObject.getCategoriesObject)(products);
  ...
  for (const property in modifiedCategores) {
    ...
    const img = modifiedCategores[property].item.image_url ? modifiedCategores[property].item.image_url : ((_a = modifiedCategores[property].item.image) === null || _a === void 0 ? void 0 : _a.url) ? `${_settings.BASE_URL}${(_b = modifiedCategores[property].item.image) === null || _b === void 0 ? void 0 : _b.url}` : `https://res.cloudinary.com/djey7uz4e/image/upload/v1606132924/noImage_plcdvu.jpg`;
...
exports.renderGridCategory = renderGridCategory;
},{"../helpers/getCategoriesObject":"ts/helpers/getCategoriesObject.ts","../utils/settings":"ts/utils/settings.ts"}],"ts/helpers/loadCurrentItems.ts":[function(require,module,exports) {
"use strict";
...
},{"../utils/storage":"ts/utils/storage.ts"}],"ts/helpers/getLoggedInUser.ts":[function(require,module,exports) {
"use strict";
...
},{"../helpers/loadCurrentItems":"ts/helpers/loadCurrentItems.ts","../elements/renderAllProducts":"ts/elements/renderAllProducts.ts","../elements/spinner":"ts/elements/spinner.ts"}],"ts/helpers/showMessage.ts":[function(require,module,exports) {
"use strict";
...
},{}],"ts/ui/updateProduct.ts":[function(require,module,exports) {
"use strict";
...
const updateProduct = (obj, url, token) => __awaiter(void 0, void 0, void 0, function* () {
  const options = {
    method: "PUT",
    headers: {
  ...
  (0, _fetcData.fectData)(url, options).then(product => {
    if (!product || typeof product === "string") {
      return (0, _showMessage.showMessage)("danger", product, ".edit-form .message-container");
    }

    if (product.updated_at) {
      const msg = "Product has been updated.";
      return (0, _showMessage.showMessage)("success", msg, ".edit-form .message-container");
    }

    if (product.error) {
      const msg = product.error;
      return (0, _showMessage.showMessage)("danger", msg, ".edit-form .message-container");
    }
  });
});

exports.updateProduct = updateProduct;
},{"../helpers/showMessage":"ts/helpers/showMessage.ts","../helpers/fetcData":"ts/helpers/fetcData.ts"}],"ts/helpers/removeMessage.ts":[function(require,module,exports) {
"use strict";
...
},{"./showMessage":"ts/helpers/showMessage.ts","./removeMessage":"ts/helpers/removeMessage.ts","./isValidImageUrl":"ts/helpers/isValidImageUrl.ts"}],"ts/elements/renderHerobanner.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.editBackgroundImg = void 0;

var _settings = require("../utils/settings");

var _storage = require("../utils/storage");

var _updateProduct = require("../ui/updateProduct");
...
const editBackgroundImg = () => {
  const token = (0, _storage.getFromLocal)(_settings.userToken);
  const URL = `${_settings.BASE_URL}/home`;
  ...
  const handleBgChange = e => {
    e.preventDefault();
    const isValid = (0, _validateFields.validateFields)("#editBg-form .form-control");
    if (isValid !== true) return;
    const productObj = {
      hero_banner_alt_text: altText.value,
      hero_url: imgUrl.value
    };
    (0, _updateProduct.updateProduct)(productObj, URL, token);
    location.reload();
  };
...
exports.editBackgroundImg = editBackgroundImg;
...
const renderHeroBanner = url => {
  ...
  const edit = user && user.username === "admin" ? ` <button type="button" class="btn btn-info btn-sm edit-btn edit-bg" data-toggle="modal" data-target="#herobannerBg">Edit image</button>` : "";
  herobannerContent.innerHTML += edit;
};

var _default = renderHeroBanner;
exports.default = _default;
},{"../utils/settings":"ts/utils/settings.ts","../utils/storage":"ts/utils/storage.ts","../ui/updateProduct":"ts/ui/updateProduct.ts","../helpers/validateFields":"ts/helpers/validateFields.ts","../helpers/getLoggedInUser":"ts/helpers/getLoggedInUser.ts"}],"ts/elements/renderFeatured.ts":[function(require,module,exports) {
"use strict";
...
const displayFeaturedProducts = featuredPropducts => {
  ...
  <ul class="custom-carousel_slide-container">
    ...
    return `<li class="custom-carousel__slide ">${(0, _card.card)(product)}</li>`;
  }).join("")}
  </ul>
...
var _default = renderFeatured;
exports.default = _default;
},{"../helpers/saveFavourites":"ts/helpers/saveFavourites.ts","../components/card":"ts/components/card.ts"}],"ts/ui/logout.ts":[function(require,module,exports) {
"use strict";
...
},{"../utils/settings":"ts/utils/settings.ts","../utils/storage":"ts/utils/storage.ts","../elements/renderAllProducts":"ts/elements/renderAllProducts.ts","lodash-es/debounce":"../node_modules/lodash-es/debounce.js"}],"ts/ui/login.ts":[function(require,module,exports) {
"use strict";
...
},{}],"ts/helpers/registerValidation.ts":[function(require,module,exports) {
"use strict";
...
},{"../utils/settings":"ts/utils/settings.ts","../ui/logout":"ts/ui/logout.ts","../ui/renderSearch":"ts/ui/renderSearch.ts","../helpers/loadCurrentItems":"ts/helpers/loadCurrentItems.ts","../ui/login":"ts/ui/login.ts","../ui/register":"ts/ui/register.ts","../ui/showNavbarBgOnScroll":"ts/ui/showNavbarBgOnScroll.ts","../helpers/getLoggedInUser":"ts/helpers/getLoggedInUser.ts"}],"ts/index.ts":[function(require,module,exports) {
"use strict";

var _renderGridCategory = require("./elements/renderGridCategory");

var _settings = require("./utils/settings");

var _renderHerobanner = _interopRequireWildcard(require("./elements/renderHerobanner"));

var _renderFeatured = _interopRequireDefault(require("./elements/renderFeatured"));
...
(() => __awaiter(void 0, void 0, void 0, function* () {
  (0, _removeMessage.removeMessage)(".herobanner .message-container");
  (0, _removeMessage.removeMessage)(".featured-container .message-container");
  const heroLoader = document.querySelector(".hero-loader ");
  const products = (0, _storage.getFromSessionStorage)(_settings.allProducts);
  const hero = (0, _storage.getFromSessionStorage)("herobanner");
  ...
  if (products !== null && hero !== null) {
    ...
    const homeUrl = `${_settings.BASE_URL}/home`;
    const productsUrl = `${_settings.BASE_URL}/products`;
    (0, _spinner.spinner)(".featured-container");
    const [homeResponse, productResponse] = yield Promise.all([(0, _fetcData.fectData)(homeUrl), (0, _fetcData.fectData)(productsUrl)]);

    if (!homeResponse || typeof homeResponse === "string") {
      const msg = "Failed to get background image, couble check the url.";
      return (0, _showMessage.showMessage)("danger", msg, ".herobanner .message-container");
    }

    (0, _renderHerobanner.default)(homeResponse.hero_url);

    if (!productResponse || typeof productResponse === "string") {
      (0, _showMessage.showMessage)("danger", "Sorry, an error happened. Please, try again later.", ".featured-container .message-container");
      return;
    }
